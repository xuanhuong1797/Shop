  ...
  <div class="row">
    ...
    <div class="card-wrapper col-md-8" style="margin: auto;">
      <div class="card">
        ...
        <form method="post" action="<?php echo e(route('admin.products.edit',$products->id)); ?>">
          <?php echo csrf_field(); ?>
          <div class="form-group">
            <label for="name">Name</label>
            <input type="text" value="<?php echo e($products->name); ?>"
...
if (isset($messageCache)) { $message = $messageCache; }
            ...
            id="description" rows="3"><?php echo e($products->description); ?></textarea>
...
if (isset($messageCache)) { $message = $messageCache; }
          ...
          <div class="form-group">
            ...
            <input type="text" name="quantity" value="<?php echo e($products->quantity); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PHP\PHP07\E-Shopper\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>